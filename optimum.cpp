...
void optimum::Init(int n)
{
	...
	int Stage1_Name[48] = {
		4,3,6,10,10,8,8,1,9,9,5,2,4,3,3,6,10,8,1,9,
		9,7,7,5,2,4,3,6,6,10,8,1,2,2,4,3,6,10,10,8,
		8,1,3,3,6,8,8,1 };
	int Stage1_Dir[48] = {
	...
	int Stage2_Name[62] = {
		3,6,5,9,9,7,7,1,10,10,4,9,9,7,7,1,10,10,8,8,
		4,7,7,1,6,6,5,2,3,9,9,7,7,1,6,5,5,2,3,7,
		7,1,4,8,8,10,10,5,6,2,3,7,7,9,9,1,2,2,3,9,
		9,1 };
	int Stage2_Dir[62] = {
	...
	int Stage4_Name[125] = {
		8,10,6,6,1,5,5,9,9,4,2,2,6,8,10,9,7,4,3,3,
		5,1,8,8,9,9,7,7,4,10,10,2,3,4,7,7,4,4,3,2,
		7,10,3,5,5,1,9,9,4,6,10,7,2,2,5,3,1,9,9,8,
		8,4,10,10,1,5,5,3,7,7,1,8,8,9,9,4,4,10,10,6,
		6,1,9,9,5,3,3,9,9,5,8,10,4,3,5,1,6,6,4,10,
		8,3,5,5,1,8,10,6,2,7,7,9,9,1,5,3,4,4,10,8,
		6,2,9,9,1 };
	int Stage4_Dir[125] = {
	...
	int Stage5_Name[178] = {
		4,8,8,10,10,4,8,10,6,5,5,7,10,9,8,4,4,6,8,10,
		5,8,8,6,4,4,9,9,7,7,2,2,1,3,8,5,10,9,7,2,
		10,5,8,3,1,10,10,2,2,9,7,6,4,8,8,3,3,1,10,2,
		9,7,4,8,3,5,9,9,5,3,8,4,7,2,2,10,9,1,3,3,
		8,8,4,7,2,5,8,3,3,1,9,9,5,2,7,4,3,8,1,9,
		9,10,10,5,8,8,1,9,9,10,10,5,5,8,8,2,2,7,7,6,
		4,3,9,9,10,10,1,7,2,8,5,5,1,3,10,9,4,4,6,2,
		8,7,3,10,10,1,5,5,8,7,2,3,6,4,4,10,9,1,5,7,
		7,8,8,2,3,6,4,10,10,9,9,1,6,6,4,9,9,1 };
	int Stage5_Dir[178] = {
...
int optimum::moveRole(int n)
{
	return nametable[n];
}
int optimum::moveDir(int n)
{
	return dirtable[n];
}